// drawFreqChart function
function drawFreqChart() {
  var queryString = encodeURIComponent('SELECT Q, R LIMIT 5 OFFSET 1')
...
function handleQueryResponse(response) {
  ...
  var options = {
    title:'Poll Q.: How often do you drink beer?',
...
//    height:600,
  ...
  $(document).ready(function(){
    $("#chart_Freq_button").on("click", drawFreqChart)
  });
}};
